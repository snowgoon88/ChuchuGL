...
#ifndef GL_3DTEXT_SHADERS_HPP
#define GL_3DTEXT_SHADERS_HPP

/** 
 * Display texts using shaders and a projection matrix.
...
#define FONT_SIZE 12
#define SHADERS_PATH std::string( "src/shaders/text3d_fade" )
// ***************************************************************************
// ************************************************************* GLTextShaders
// ***************************************************************************
class GL3DTextShaders
{
  struct point { GLfloat x; GLfloat y; GLfloat s; GLfloat t; };
public:
  // *********************************************** GL3DTextShaders::creation
  GL3DTextShaders() :
    _sx( 1.f ), _sy( 1.f )
  {
  ...
  // ******************************************* GL3DTextShaders::pre_render
  void pre_render( const glm::mat4& projection,
				   ...
				   const glm::quat& rotation = {0,0,0,1} )
  {
    ...
    glm::mat4 translation_mtx = glm::translate(  glm::mat4(1.0f),
						 origin );
    glm::mat4 mvp = projection * translation_mtx * rotation_mtx * pre_rot;// * scale_mtx;
  ...
  // ******************************************** GL3DTExtShaders::post_render
  void post_render()
  {
    //glDisableVertexAttribArray(_attribute_coord);
    glDeleteTextures(1, &_tex);
  };
  // ************************************* GL3DTextShaders::compute_lineheight
  /**
   * Size of the 'O'
   */
...
protected:
  ...
  /** Uniform var */
  GLint _uniform_tex, _uniform_color, _uniform_mvp;
