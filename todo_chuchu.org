...
** DONE Pourquoi ca marche pas sur usukun ??
placer les fichiers au bon endroit
** TODO [3/5] Lancer un thread avec Play
*** DONE Nourrir le thread
*** TODO Eventuellement, permettre ensuite le mix
*** DONE Set Volume
*** DONE Get Mute ?
*** TODO Loop if finished
** TODO [0/1] Mix
*** Z=A+B−AB.
*** TODO 2 (ou 3) streams ??
** Music
...
* [7/8] New beginning <2015-12-02 Wed>
