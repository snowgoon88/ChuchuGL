...
** TODO [4/5] display info, [[affichage fps][FPS]]
*** DONE [1/1] Info vu
**** DONE msg + cadre autour du msg + cadre autour cell + line => dynamic VBO
Chaque autre agent dans FOV pourrait déclencher un Overlay
*** TODO FPS pourrait être aussi affiché dans Anttweak
...
* SOIL : image width doit être un multiple de 4 !!   
