...
*** TODO [2/5] use framebuffer and Tron texture, as in example : understand Glow
...
**** TODO render colored lines in Framebuffer and display in top-right
**** TODO draw the texture as planned by Glow
**** TODO "convolution" with the texture
