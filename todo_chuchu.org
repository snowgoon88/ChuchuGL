* Current => Camera
* [1/3] Camera <2017-07-26 mer.>
** DONE [1/1] ship to GL3DObject
*** DONE add shaders to GL3DEngine
** TODO make ship go circling in simulator
** TODO [0/2] attach camera
*** TODO behind ship
*** TODO in cockpit
* [0/2] Physics <2017-07-19 Wed>
** TODO [2/3] Base transformation avec rotation
*** DONE glm::rotate( q, vec3)
*** DONE glm::inverse( q )
*** TODO Show in simu
** TODO Integration : apply speed_n to compute pos_{n+1} before computing speed_{n+1}
** 3D Forces
** 3D Rotation
*** Quat tp 3x3 rotation matrix
