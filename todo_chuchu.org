...
** TODO [1/5] new Text Shader <2019-05-05 dim.>
- inspiré de https://learnopengl.com/Getting-started/Shaders
*** Comparer shaders
- vShader : mul by projection
- fShader : use RED as alpha value
*** Comparer Shader Load and use program
- learn = same, but with a set of setBool, setFloat, etc... that need to request, each time, the location of the uniform
- learn : does not load geometry
++ (maybe) does not question which glUniformXX to use
*** Render Text
-- does not need coord attribut, as layout 0
*** Texture Atlas
https://en.wikibooks.org/wiki/OpenGL_Programming/Modern_OpenGL_Tutorial_Text_Rendering_02
*** DONE Outline glyph in rendering texture atlas ?
*** Exemple de GLConsole
SDL https://github.com/rlt3/SDL-Console/blob/master/SDL_console.c
GLUT https://www.developpez.net/forums/d409919/applications/developpement-2d-3d-jeux/api-graphiques/opengl/glut/creer-console-glut/
*** TODO Build entire TextMap
<<build TextMap>>
*** TODO Different TextMap at different font size -> struct/class for TextMap
*** TODO higlighted letter
<<higlight>>
**** TODO Blinking letter
*** Should test with only UTF8 handling ?
<<utf8 only>>
*** Unicode => [[test/test-014-utf8.cpp]]
https://stackoverflow.com/questions/50403342/how-do-i-properly-use-stdstring-on-utf-8-in-c
https://en.wikipedia.org/wiki/UTF-8

Idée principale : un Codepoint est représenté par un certain nomnbre de bit qu'il faut représenter avec plus ou moins de UTF8 (8bits) ou UTF16 (16bits) ou plus.

Si U > x7F, alors c'est sur 2 octets 110x xxxx et 10xx xxxx
Ex : É = U+C9 (221) = 1100 1001 => 1100 0011 et 1000 1001
